...
This directory contains the English user-facing documentation for dagent. The
root [`README.md`](../../README.md) introduces the project and keeps the
architecture overview close to the project identity. The pages here focus on
installation, SDK usage, feature guides, and released behavior.
