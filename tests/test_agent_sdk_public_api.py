...
def test_package_exposes_tool_and_separate_agent_entrypoints() -> None:
    ...
    assert hasattr(dagent, "DAGDesignProposal")
    assert hasattr(dagent, "DAGDesignNoChange")
    assert hasattr(dagent, "DAGDesignAnswer")
    assert hasattr(dagent, "DAGDesignFailure")
    assert hasattr(dagent, "DAGDesignSelection")
    assert hasattr(dagent, "DAGDiagnostic")
    assert hasattr(dagent, "inspect_dag_spec")
    assert hasattr(dagent, "Node")
    assert hasattr(dagent.Runner, "stream")
    assert hasattr(dagent.Runner, "resume_stream")
    assert hasattr(dagent.Runner, "steer")
    assert hasattr(dagent, "SteerReceipt")
    assert hasattr(dagent, "SteerError")
    assert hasattr(dagent, "RunNotActiveError")
    assert hasattr(dagent, "RunNotSteerableError")
    assert hasattr(dagent, "SteerQueueFullError")
    assert hasattr(dagent.Runner, "add_agent")
    assert hasattr(dagent.Runner, "design_dag")
